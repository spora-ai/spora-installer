...
test('getInstallPath() returns public/spora/ regardless of package name', function (): void {
    $installer = new SporaFrontendInstaller(new NullIO(), makeComposerMock());
    ...
    expect($installer->getInstallPath($frontend))->toBe('public/spora/');
    expect($installer->getInstallPath($acme))->toBe('public/spora/');
});
